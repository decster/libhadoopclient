...
void protobuf_AssignDesc_RpcHeader_2eproto() {
  ...
  RpcRequestHeaderProto_descriptor_ = file->message_type(0);
  static const int RpcRequestHeaderProto_offsets_[5] = {
  ...
  RpcResponseHeaderProto_descriptor_ = file->message_type(1);
  ...
  RpcSaslProto_descriptor_ = file->message_type(2);
